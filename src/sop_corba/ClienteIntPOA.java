 ...
 implements sop_corba.ClienteIntOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("recibirAudio", new java.lang.Integer (6));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 6:  // sop_corba/ClienteInt/recibirAudio
       {
         byte audioStreaming[] = sop_corba.ClienteIntPackage.audioHelper.read (in);
         this.recibirAudio (audioStreaming);
         out = $rh.createReply();
         break;
       }
